// экранирует потенциально опасные символы, чтобы текст не превращался в HTML
...
// экранирует спецсимволы, чтобы при их вводе в поиск функция подсветки не путала символы с паттерном RegExp
